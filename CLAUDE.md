...
staticrypt --decrypt -p "Or@ngeTr@il2025" index.html -d decrypted_pages

# Edit decrypted_pages/index.html

# Re-encrypt
staticrypt decrypted_pages/index.html -p "Or@ngeTr@il2025" --salt 9a33add92f11f72ec2c82098ef4dc579 -d .
```
